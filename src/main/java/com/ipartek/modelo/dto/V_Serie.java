...
public class V_Serie {
	...
	public V_Serie(int idSerie, String serie, int num_temporadas, String descripcion_serie, int fK_usuario,
			String usuario) {
		super();
	...
	public String toString() {
		return "V_Serie [idSerie=" + idSerie + ", serie=" + serie + ", num_temporadas=" + num_temporadas
				+ ", descripcion_serie=" + descripcion_serie + ", FK_usuario=" + FK_usuario + ", usuario=" + usuario
				+ "]";
	}
